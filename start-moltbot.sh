...
if (isOpenAI) {
    ...
    config.agents.defaults.model.primary = config.agents.defaults.model.primary || 'openai/gpt-5.2';
} else if (baseUrl) {
    ...
    config.agents.defaults.model.primary = config.agents.defaults.model.primary || 'anthropic/claude-opus-4-5-20251101';
} else {
    ...
    config.agents.defaults.models['anthropic/claude-sonnet-4-5-20250929'] = { alias: 'Sonnet 4.5' };
    config.agents.defaults.models['anthropic/claude-haiku-4-5-20251001'] = { alias: 'Haiku 4.5' };
    // Only set default if not already configured (preserves R2-synced model choice)
    config.agents.defaults.model.primary = config.agents.defaults.model.primary || 'anthropic/claude-opus-4-5';
}
